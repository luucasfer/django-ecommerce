"""
Django settings for multitenantEcomm project.
...
ROOT_URLCONF = "multitenantEcomm.urls"
...
WSGI_APPLICATION = "multitenantEcomm.wsgi.application"
...
DATABASES = {
    'default': {
        ...
        'HOST': os.environ.get('POSTGRES_HOST', 'localhost'),  # Use 'localhost' as default
        'PORT': os.environ.get('POSTGRES_PORT', '5432'),  # Use '5432' as default
    }
}
